...
t7$TOT_1 <- ifelse(!t7$marca_indi%in%0 & f1%in%T, t7$FACTOR_PER, 0)  
t7$TOT_2 <- ifelse(!t7$marca_indi%in%0 & f2%in%T, t7$FACTOR_PER, 0)  
...
t7$TOT <- ifelse(!t7$marca_indi%in%0 & t7$SEXO%in%",i,", t7$FACTOR_PER, 0)  
t7$TOT_1<-ifelse(!t7$marca_indi%in%0 & t7$SEXO%in%",i," & f1%in%T, t7$FACTOR_PER, 0)  
t7$TOT_2<-ifelse(!t7$marca_indi%in%0 & t7$SEXO%in%",i," & f2%in%T, t7$FACTOR_PER, 0)  
t7$TOT_3 <- t7$TOT- t7$TOT_1- t7$TOT_2
asp <- svydesign(id=~as.numeric(UPM_DIS), weights=~1, data=t7, strata=~as.numeric(EST_DIS))
xx <-c('TOT', paste0('TOT_',1:3))
...
t7$TOT <- ifelse(!t7$marca_indi%in%0 & (f01 | f02 | f03 | f04 | f05 | f06 | f07 | f08), t7$FACTOR_PER, 0)
for(i in 1:length(b))eval(parse(text = paste0("
t7$TOT_",i," <- ifelse(!t7$marca_indi%in%0 & f1",i,"%in%T, t7$FACTOR_PER, 0)
")))
t7$TOT_8<- ifelse(!t7$marca_indi%in%0 & f18%in%T, t7$FACTOR_PER, 0)
...
t7$TOT <- ifelse(!t7$marca_indi%in%0 & t7$SEXO%in%'2' & (f01 | f02 | f03 | f04 | f05 | f06 | f07 | f08), t7$FACTOR_PER, 0)
for(i in 1:length(b))eval(parse(text = paste0("
t7$TOT_",i," <- ifelse(!t7$marca_indi%in%0 & t7$SEXO%in%'2' & f1",i,"%in%T, t7$FACTOR_PER, 0)
")))
t7$TOT_8 <- ifelse(!t7$marca_indi%in%0 & t7$SEXO%in%'2' & f18%in%T, t7$FACTOR_PER, 0)
...
t7$TOT <- ifelse(!t7$marca_indi%in%0 & t7$SEXO%in%'1' & (f01 | f02 | f03 | f04 | f05 | f06 | f07 | f08), t7$FACTOR_PER, 0)
for(i in 1:length(b))eval(parse(text = paste0("
t7$TOT_",i," <- ifelse(!t7$marca_indi%in%0 & t7$SEXO%in%'1' & f1",i,"%in%T, t7$FACTOR_PER, 0)")))
