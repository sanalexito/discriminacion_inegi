library(foreign)
library(survey)
source('D:/ENADIS/Entregable_enadis_2022/Calculadores/Tab_vertical.R')
source('D:/ENADIS/Entregable_enadis_2022/Calculadores/Pega_tab_1.R')
source('D:/ENADIS/Entregable_enadis_2022/Calculadores/Tab_2.R')
...
cc <- c("Ser persona indígena o afrodescendiente",
        "Tener alguna discapacidad",
        "Tener alguna enfermedad",
        "Opiniones políticas",
        "Estado civil o su situación de pareja o familiar (embarazada, huérfana(o) o adoptada(o))",
...
df$estrella <- ifelse(!df$Tendencia%in%c('Igual', NA), paste0(round(df[,3],1),'*'), df[,3]) 
