...
etiquetas0 <- c('No entiende lo que dice porque solo está en español',
...
f1 <- eval(parse(text = paste0("t7$PM1_6_0",1:9,"%in%'1'", collapse = "|")))
t7$TOT <- ifelse(t7$marca_indi%in%1 & f1%in%T, t7$FACTOR_PER, 0)
f2 <- eval(parse(text = paste0("t7$PM1_6_0",1:8,"%in%'1'", collapse = "|")))
t7$TOT_1 <- ifelse(t7$marca_indi%in%1 & f2%in%T, t7$FACTOR_PER,0)
t7$TOT_2 <- ifelse(t7$marca_indi%in%1 & t7$PM1_6_09%in%'1', t7$FACTOR_PER,0)
...
t7$TOT <- ifelse(t7$SEXO%in%'2' & t7$marca_indi%in%1 & f1%in%T, t7$FACTOR_PER, 0)
t7$TOT_1 <- ifelse(t7$SEXO%in%'2' & t7$marca_indi%in%1 & f2%in%T, t7$FACTOR_PER,0)
t7$TOT_2 <- ifelse(t7$SEXO%in%'2' & t7$marca_indi%in%1 & t7$PM1_6_09%in%'1', t7$FACTOR_PER,0)
asp <- svydesign(id=~as.numeric(UPM_DIS), weights=~1, data=t7, strata=~as.numeric(EST_DIS))
xx <-c('TOT', paste0('TOT_',1:2))
tab1_2 <- Tab_vert_a(xx, c("Ha buscado información", 'Ha tenido algún problema', 'No ha tenido ningún problema'))

t7$TOT <- ifelse(t7$SEXO%in%'1' & t7$marca_indi%in%1 & f1%in%T, t7$FACTOR_PER, 0)
t7$TOT_1 <- ifelse(t7$SEXO%in%'1' & t7$marca_indi%in%1 & f2%in%T, t7$FACTOR_PER,0)
t7$TOT_2 <- ifelse(t7$SEXO%in%'1' & t7$marca_indi%in%1 & t7$PM1_6_09%in%'1', t7$FACTOR_PER,0)
asp <- svydesign(id=~as.numeric(UPM_DIS), weights=~1, data=t7, strata=~as.numeric(EST_DIS))
xx <-c('TOT', paste0('TOT_',1:2))
...
#-------------------------------------------------------------------------------
f1 <- eval(parse(text = paste0("t7$PM1_6_0",1:8,"%in%'1'", collapse = "|")))
t7$TOT <- ifelse(t7$marca_indi%in%1 & f1, t7$FACTOR_PER, 0)
for(i in 1:8) eval(parse(text = paste0("
t7$TOT_",i," <- ifelse(t7$marca_indi%in%1 & t7$PM1_6_0",i,"%in%'1', t7$FACTOR_PER, 0)")))
asp <- svydesign(id=~as.numeric(UPM_DIS), weights=~1, data=t7, strata=~as.numeric(EST_DIS))
xx <-c('TOT', paste0('TOT_',1:8))
tab2_1 <- Tab_vert_a(xx, c("Ha tenido algún problema", etiquetas0))

#col 2 y3 
t7$TOT <- ifelse(t7$SEXO%in%'2' & t7$marca_indi%in%1 & f1, t7$FACTOR_PER, 0)
for(i in 1:8) eval(parse(text = paste0("
t7$TOT_",i," <- ifelse(t7$SEXO%in%'2' & t7$marca_indi%in%1 & t7$PM1_6_0",i,"%in%'1', t7$FACTOR_PER, 0)")))
asp <- svydesign(id=~as.numeric(UPM_DIS), weights=~1, data=t7, strata=~as.numeric(EST_DIS))
xx <-c('TOT', paste0('TOT_',1:8))
tab2_2 <- Tab_vert_a(xx, c("Ha tenido algún problema", etiquetas0))

t7$TOT <- ifelse(t7$SEXO%in%'1' & t7$marca_indi%in%1 & f1, t7$FACTOR_PER, 0)
for(i in 1:8) eval(parse(text = paste0("
t7$TOT_",i," <- ifelse(t7$SEXO%in%'1' & t7$marca_indi%in%1 & t7$PM1_6_0",i,"%in%'1', t7$FACTOR_PER, 0)")))
asp <- svydesign(id=~as.numeric(UPM_DIS), weights=~1, data=t7, strata=~as.numeric(EST_DIS))
xx <-c('TOT', paste0('TOT_',1:8))
tab2_3 <- Tab_vert_a(xx, c("Ha tenido algún problema", etiquetas0))

#-------------------------------------------------------------------------------
si_y_no <- c('Ha buscado información', 'Nunca ha buscado información')
t7$TOT <- ifelse(t7$marca_indi%in%1, t7$FACTOR_PER, 0)
t7$TOT_2 <- ifelse(t7$marca_indi%in%1 & t7$PM1_6_10%in%1, t7$FACTOR_PER, 0)
...
t7$TOT_2 <- ifelse(t7$marca_indi%in%1 & t7$PM1_6_10%in%1 & t7$SEXO%in%'2', t7$FACTOR_PER, 0)
t7$TOT_1 <- t7$TOT-t7$TOT_2
asp <- svydesign(id=~as.numeric(UPM_DIS), weights=~1, data=t7, strata=~as.numeric(EST_DIS))
xx <-c('TOT', paste0('TOT_',1:2))
...
t7$TOT_2 <- ifelse(t7$marca_indi%in%1 & t7$PM1_6_10%in%1 & t7$SEXO%in%'1', t7$FACTOR_PER, 0)
t7$TOT_1 <- t7$TOT-t7$TOT_2
asp <- svydesign(id=~as.numeric(UPM_DIS), weights=~1, data=t7, strata=~as.numeric(EST_DIS))
xx <-c('TOT', paste0('TOT_',1:2))
