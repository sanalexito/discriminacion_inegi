...
f0 <- eval(parse(text = paste0("t7$PM9_4_",1:8,"%in%c('1','2')", collapse = "|")))
...
t7$TOT_1 <- ifelse(!t7$POBF1_1%in%0 & f1%in%T, t7$FACTOR_PER, 0)  
t7$TOT_2 <- ifelse(!t7$POBF1_1%in%0 & f2%in%T, t7$FACTOR_PER, 0)  
...
t7$TOT <- ifelse(!t7$POBF1_1%in%0 & t7$SEXO%in%",i,", t7$FACTOR_PER, 0)  
t7$TOT_1<-ifelse(!t7$POBF1_1%in%0 & t7$SEXO%in%",i," & f1%in%T, t7$FACTOR_PER, 0)  
t7$TOT_2<-ifelse(!t7$POBF1_1%in%0 & t7$SEXO%in%",i," & f2%in%T, t7$FACTOR_PER, 0)  
t7$TOT_3 <- t7$TOT- t7$TOT_1- t7$TOT_2
asp <- svydesign(id=~as.numeric(UPM_DIS), weights=~1, data=t7, strata=~as.numeric(EST_DIS))
xx <-c('TOT', paste0('TOT_',1:3))
...
t7$TOT <- ifelse(!t7$POBF1_1%in%0 & (f01 | f02 | f03 | f04 | f05 | f06 | f07 | f08), t7$FACTOR_PER, 0)
for(i in 1:length(b))eval(parse(text = paste0("
t7$TOT_",i," <- ifelse(!t7$POBF1_1%in%0 & f1",i,"%in%T, t7$FACTOR_PER, 0)
")))
t7$TOT_8<- ifelse(!t7$POBF1_1%in%0 & f18%in%T, t7$FACTOR_PER, 0)
...
t7$TOT <- ifelse(!t7$POBF1_1%in%0 & t7$SEXO%in%'2' & (f01 | f02 | f03 | f04 | f05 | f06 | f07 | f08), t7$FACTOR_PER, 0)
for(i in 1:length(b))eval(parse(text = paste0("
t7$TOT_",i," <- ifelse(!t7$POBF1_1%in%0 & t7$SEXO%in%'2' & f1",i,"%in%T, t7$FACTOR_PER, 0)
")))
t7$TOT_8 <- ifelse(!t7$POBF1_1%in%0 & t7$SEXO%in%'2' & f18%in%T, t7$FACTOR_PER, 0)
...
t7$TOT <- ifelse(!t7$POBF1_1%in%0 & t7$SEXO%in%'1' & (f01 | f02 | f03 | f04 | f05 | f06 | f07 | f08), t7$FACTOR_PER, 0)
for(i in 1:length(b))eval(parse(text = paste0("
t7$TOT_",i," <- ifelse(!t7$POBF1_1%in%0 & t7$SEXO%in%'1' & f1",i,"%in%T, t7$FACTOR_PER, 0)")))
t7$TOT_2 <- 0.0000000001
...
#-------------------------------------------------------------------------------
tabulado <- purrr::map(.x =1:4, .f= ~rbind(nacional[[.x]][1,], 
                                           nacional[[.x]][2,], 
                                           bloque1[[.x]][2:9,], 
                                           nacional[[.x]][3:4,])) 
...
tabulado[[1]][c(4,9), 8] <- "0*"
tabulado[[1]][c(4,9), 9] <- "0.0*"
tabulado[[1]][c(9), 8:9] <- NA

for(i in c(2,4)){
  tabulado[[i]][c(4,9), 8:9] <- "NA"
}

tabulado[[3]][c(4,9),c(14,15, 17, 18)] <- "NA"
# 
...
# 
# t7$TOT <- ifelse(!t7$POBF1_1%in%0 & f1%in%T, t7$FACTOR_PER, 0) 
# t7$TOT_1 <- ifelse(!t7$POBF1_1%in%0 & f0_d%in%T, t7$FACTOR_PER, 0 )
# t7$TOT_2 <-ifelse(!t7$POBF1_1%in%0 & t7$PM9_5_1_9%in%'1', t7$FACTOR_PER, 0)
# t7$TOT_3 <-ifelse(!t7$POBF1_1%in%0 & 
#                     (t7$PM9_5_2_9%in%'1' | t7$PM9_5_3_10%in%'1' | t7$PM9_5_6_9%in%'1'), t7$FACTOR_PER, 0)
# t7$TOT_4 <-ifelse(!t7$POBF1_1%in%0 & 
#                     (t7$PM9_5_2_10%in%'1' | t7$PM9_5_3_9%in%'1' |t7$PM9_5_4_9%in%'1'|
#                        t7$PM9_5_7_9%in%'1'  | t7$PM9_5_8_10%in%'1'), t7$FACTOR_PER, 0)
# t7$TOT_5 <-ifelse(!t7$POBF1_1%in%0 & 
#                     (t7$PM9_5_4_10%in%'1' | t7$PM9_5_8_9%in%'1'), t7$FACTOR_PER, 0)
# t7$TOT_6 <-ifelse(!t7$POBF1_1%in%0 & t7$PM9_5_6_10%in%'1', t7$FACTOR_PER, 0)
# t7$TOT_7 <-ifelse(!t7$POBF1_1%in%0 & t7$PM9_5_6_11%in%'1', t7$FACTOR_PER, 0)
# 
# t7$TOT_8 <- ifelse(!t7$POBF1_1%in%0 & 
...
# 
# for(i in 1:2) eval(parse(text = paste0("
# t7$TOT <- ifelse(t7$SEXO%in%",i," & !t7$POBF1_1%in%0 & f1%in%T, t7$FACTOR_PER, 0) 
# t7$TOT_1 <- ifelse( t7$SEXO%in%",i," & !t7$POBF1_1%in%0 & f0_d%in%T, t7$FACTOR_PER, 0 )
# t7$TOT_2 <-ifelse(t7$SEXO%in%",i," & !t7$POBF1_1%in%0 & t7$PM9_5_1_9%in%'1', t7$FACTOR_PER, 0)
# t7$TOT_3 <-ifelse(t7$SEXO%in%",i," & !t7$POBF1_1%in%0 & 
#                     (t7$PM9_5_2_9%in%'1' | t7$PM9_5_3_10%in%'1' | t7$PM9_5_6_9%in%'1'), t7$FACTOR_PER, 0)
# t7$TOT_4 <-ifelse(t7$SEXO%in%",i," & !t7$POBF1_1%in%0 & 
#                     (t7$PM9_5_2_10%in%'1' | t7$PM9_5_3_9%in%'1' |t7$PM9_5_4_9%in%'1'|
#                        t7$PM9_5_7_9%in%'1'  | t7$PM9_5_8_10%in%'1'), t7$FACTOR_PER, 0)
# t7$TOT_5 <-ifelse(t7$SEXO%in%",i," & !t7$POBF1_1%in%0 & 
#                     (t7$PM9_5_4_10%in%'1' | t7$PM9_5_8_9%in%'1'), t7$FACTOR_PER, 0)
# t7$TOT_6 <-ifelse(t7$SEXO%in%",i," & !t7$POBF1_1%in%0 & t7$PM9_5_6_10%in%'1', t7$FACTOR_PER, 0)
# t7$TOT_7 <-ifelse(t7$SEXO%in%",i," & !t7$POBF1_1%in%0 & t7$PM9_5_6_11%in%'1', t7$FACTOR_PER, 0)
# 
# t7$TOT_8 <- ifelse(t7$SEXO%in%",i," & !t7$POBF1_1%in%0 & 
#                      (t7$PM9_5_1_8%in%'1'| t7$PM9_5_2_8%in%'1'|
#                        t7$PM9_5_3_8%in%'1'| t7$PM9_5_4_8%in%'1'|
#                         t7$PM9_5_5_8%in%'1'| t7$PM9_5_6_8%in%'1'|
#                           t7$PM9_5_7_8%in%'1'| t7$PM9_5_8_8%in%'1'),
